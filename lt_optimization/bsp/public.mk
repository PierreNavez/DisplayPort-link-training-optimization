...
SOPCINFO_FILE := C:/Users/Stagiaire/Desktop/project/lt_optimization/lt_optimization.sopcinfo
...
# Design Name 
# setting SOPC_NAME is lt_optimization
SOPC_NAME := lt_optimization
...
# Enable the fstack-protector-strong compiler flag in public.mk. If true: 
# ALT_CFLAGS += -fstack-protector-strong none 
# setting hal.make.enable_cflag_fstack_protector_strong is false

# Enable the Wformat and Wformat-security compiler flags in public.mk to warn 
# against security problems when using format functions. If true: ALT_CFLAGS += 
# -Wformat -Wformat-security none 
# setting hal.make.enable_cflag_wformat_security is false
